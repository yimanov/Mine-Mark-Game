...
public class Book : MonoBehaviour
{
    ...
    public Sprite[] bookPages1;
    public Sprite[] bookPages2;
    public Sprite[] bookPages3;
    ...
    {
        if (LocalizationSettings.AvailableLocales.Locales[0] == LocalizationSettings.SelectedLocale)
        {
            if (currentPage >= bookPages1.Length) return;
            pageDragging = true;
            mode = FlipMode.RightToLeft;
            f = point;
            ...
            Left.sprite = (currentPage < bookPages1.Length) ? bookPages1[currentPage] : background1;
            Left.transform.SetAsFirstSibling();

            Right.gameObject.SetActive(true);
            Right.transform.position = RightNext.transform.position;
            Right.transform.eulerAngles = new Vector3(0, 0, 0);
            Right.sprite = (currentPage < bookPages1.Length - 1) ? bookPages1[currentPage + 1] : background1;

            RightNext.sprite = (currentPage < bookPages1.Length - 2) ? bookPages1[currentPage + 2] : background1;
        ...
        else if (LocalizationSettings.AvailableLocales.Locales[2] == LocalizationSettings.SelectedLocale)
        {
        ...
        else if (LocalizationSettings.AvailableLocales.Locales[3] == LocalizationSettings.SelectedLocale)
        {
            ...
            Left.transform.position = RightNext.transform.position;
            Left.transform.eulerAngles = new Vector3(0, 0, 0);
            Left.sprite = (currentPage < bookPages2.Length) ? bookPages2[currentPage] : background2;
            Left.transform.SetAsFirstSibling();

            Right.gameObject.SetActive(true);
            Right.transform.position = RightNext.transform.position;
            Right.transform.eulerAngles = new Vector3(0, 0, 0);
            Right.sprite = (currentPage < bookPages2.Length - 1) ? bookPages2[currentPage + 1] : background2;

            RightNext.sprite = (currentPage < bookPages2.Length - 2) ? bookPages2[currentPage + 2] : background2;
        ...
        else if (LocalizationSettings.AvailableLocales.Locales[1] == LocalizationSettings.SelectedLocale)
        {
            if (currentPage >= bookPages3.Length) return;
            pageDragging = true;
            mode = FlipMode.RightToLeft;
            f = point;
            ...
            Left.transform.position = RightNext.transform.position;
            Left.transform.eulerAngles = new Vector3(0, 0, 0);
            Left.sprite = (currentPage < bookPages3.Length) ? bookPages3[currentPage] : background3;
            Left.transform.SetAsFirstSibling();

            Right.gameObject.SetActive(true);
            Right.transform.position = RightNext.transform.position;
            Right.transform.eulerAngles = new Vector3(0, 0, 0);
            Right.sprite = (currentPage < bookPages3.Length - 1) ? bookPages3[currentPage + 1] : background3;

            RightNext.sprite = (currentPage < bookPages3.Length - 2) ? bookPages3[currentPage + 2] : background3;
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        if (LocalizationSettings.AvailableLocales.Locales[0] == LocalizationSettings.SelectedLocale)
        {
            ...
            Right.sprite = bookPages1[currentPage - 1];
            Right.transform.eulerAngles = new Vector3(0, 0, 0);
            Right.transform.SetAsFirstSibling();
            ...
            Left.transform.eulerAngles = new Vector3(0, 0, 0);
            Left.sprite = (currentPage >= 2) ? bookPages1[currentPage - 2] : background1;

            LeftNext.sprite = (currentPage >= 3) ? bookPages1[currentPage - 3] : background1;
        ...
        else if (LocalizationSettings.AvailableLocales.Locales[3] == LocalizationSettings.SelectedLocale)
        {
            ...
            Left.transform.position = LeftNext.transform.position;
            Left.transform.eulerAngles = new Vector3(0, 0, 0);
            Left.sprite = (currentPage >= 2) ? bookPages2[currentPage - 2] : background2;

            LeftNext.sprite = (currentPage >= 3) ? bookPages2[currentPage - 3] : background2;
        ...
        else if (LocalizationSettings.AvailableLocales.Locales[1]== LocalizationSettings.SelectedLocale)
        {
            ...
            Left.transform.position = LeftNext.transform.position;
            Left.transform.eulerAngles = new Vector3(0, 0, 0);
            Left.sprite = (currentPage >= 2) ? bookPages3[currentPage - 2] : background3;

            LeftNext.sprite = (currentPage >= 3) ? bookPages3[currentPage - 3] : background3;
    ...
    void UpdateSprites()
    {
        if (LocalizationSettings.AvailableLocales.Locales[0] == LocalizationSettings.SelectedLocale)
        {
            LeftNext.sprite = (currentPage > 0 && currentPage <= bookPages1.Length) ? bookPages1[currentPage - 1] : background1;
            RightNext.sprite = (currentPage >= 0 && currentPage < bookPages1.Length) ? bookPages1[currentPage] : background1;
        }

        if (LocalizationSettings.AvailableLocales.Locales[2]== LocalizationSettings.SelectedLocale)
        {
            LeftNext.sprite = (currentPage > 0 && currentPage <= bookPages.Length) ? bookPages[currentPage - 1] : background;
            RightNext.sprite = (currentPage >= 0 && currentPage < bookPages.Length) ? bookPages[currentPage] : background;
        }

        if (LocalizationSettings.AvailableLocales.Locales[3] == LocalizationSettings.SelectedLocale)
        {
            LeftNext.sprite = (currentPage > 0 && currentPage <= bookPages2.Length) ? bookPages2[currentPage - 1] : background2;
            RightNext.sprite = (currentPage >= 0 && currentPage < bookPages2.Length) ? bookPages2[currentPage] : background2;
        }

        if (LocalizationSettings.AvailableLocales.Locales[1] == LocalizationSettings.SelectedLocale)
        {
            LeftNext.sprite = (currentPage > 0 && currentPage <= bookPages3.Length) ? bookPages3[currentPage - 1] : background3;
            RightNext.sprite = (currentPage >= 0 && currentPage < bookPages3.Length) ? bookPages3[currentPage] : background3;
        }
    }
