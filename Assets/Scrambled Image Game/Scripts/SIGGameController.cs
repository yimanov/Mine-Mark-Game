...
namespace ScrambledImageGame
{
    ...
    public class SIGGameController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            else if (DropDownExample1.value1 == 3)
            {
                if (GetComponent<SIGImages>()) images = GetComponent<SIGImages>().images1;
                else Debug.LogWarning("No images list found, please attach a SIGImages component to this gamecontroller");
            }

            else if (DropDownExample1.value1 == 1)
            {
                if (GetComponent<SIGImages>()) images = GetComponent<SIGImages>().images2;
                else Debug.LogWarning("No images list found, please attach a SIGImages component to this gamecontroller");
            }

            else if (DropDownExample1.value1 == 2)
            {
                if (GetComponent<SIGImages>()) images = GetComponent<SIGImages>().images3;
                else Debug.LogWarning("No images list found, please attach a SIGImages component to this gamecontroller");
            }
        ...
        IEnumerator UpdateLevel()
        {
            ...
            if (levelText) levelText.text = levelNamePrefix.text + " " + (currentLevel + 1).ToString();
        ...
        IEnumerator GameOver(float delay)
        {
            ...
            if (gameOverCanvas)
            {
                ...
                if (gameOverCanvas.Find("ScoreTexts/Image/Score_001")) gameOverCanvas.Find("ScoreTexts/Image/Score_001").GetComponent<Text>().text = gameOverCanvas.Find("ScoreTexts/Image/Score_001").GetComponent<Text>().text +" " + score.ToString();
                ...
                gameOverCanvas.Find("ScoreTexts/Image/TextHighScore (1)").GetComponent<Text>().text = gameOverCanvas.Find("ScoreTexts/Image/TextHighScore (1)").GetComponent<Text>().text + " " + highScore.ToString();
        ...
        IEnumerator Victory(float delay)
        {
            ...
            if (victoryCanvas)
            {
                ...
                if (victoryCanvas.Find("ScoreTexts/a1") && victoryCanvas.Find("ScoreTexts/a2"))
                {
                    //Write the score text, if it exists
                    victoryCanvas.Find("ScoreTexts/a1").GetComponent<Text>().text = victoryCanvas.Find("ScoreTexts/a1").GetComponent<Text>().text + " " +  score.ToString();
                    ...
                    //Write the high sscore text
                    victoryCanvas.Find("ScoreTexts/a2").GetComponent<Text>().text = victoryCanvas.Find("ScoreTexts/a2").GetComponent<Text>().text +" " + highScore.ToString();
                }
